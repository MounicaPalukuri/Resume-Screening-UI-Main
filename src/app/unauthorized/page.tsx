export default function UnauthorizedPage({ searchParams }: { searchParams: URLSearchParams }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-900 text-center p-6">
      <div className="bg-red-100 dark:bg-red-800 p-8 rounded-xl shadow-xl max-w-xl">
        ...
        <button className="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition" type="button" onClick={() => {}}>
          Return
        </button>
      </div>
    </div>
