...
export default function ProfilePage() {
  const [profile, setProfile] = useState({
    ...
    email: "mounicapalukuri@gmail.com",
    phone: "N/A",
    dateOfBirth: "11/07/2005",
    country: "India",
    language: "English (United States), English (India)",
    regionalFormat: "English (India); 11-07-2005; 01:01 AM - 11:59 PM",
  ...
  const handleSelectChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    setTempValue(selectedOptions.join(", "));
  };
      ...
      <div className="flex-1">
        ...
        {editingField === field ? (
          isDateField ? (
            ...
            <select
              value={field === "language" ? tempValue.split(", ") : tempValue}
              onChange={onSelectChange}
              className="mt-1 p-2 border rounded w-full"
              multiple={field === "language"} // Enable multiple selection for language
            >
              {options.map((option) => (
