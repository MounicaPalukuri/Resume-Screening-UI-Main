    ...
    >
      ...
      <nav className="relative flex-1 mt-4 overflow-hidden">
        <ul className="space-y-1 px-4">
          ...
          <button type="button" className="flex items-center p-2 rounded-md hover:bg-red-50 dark:hover:bg-red-900/20 transition text-red-500 dark:text-red-400 group mt-6" onClick={() => {}}>
